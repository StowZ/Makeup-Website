    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>TND{{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>TND{{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>TND{{number_format($shipping_charge[0],2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                TND{{number_format($order->total_amount,2)}}
            </span>
          </th>
        </tr>
      </tfoot>
